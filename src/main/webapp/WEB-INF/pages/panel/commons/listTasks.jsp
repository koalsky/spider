    ...
    <div class="row">
        <div class="panel panel-info">
            <div class="panel-body bg-info">
                <h5 class="col-sm-2">抓取任务数：&nbsp;${resultBundle.count}&nbsp;个</h5>
                <h5 class="col-sm-2">运行任务数：&nbsp;${runningTaskCount}&nbsp;个</h5>
                <div class="col-sm-offset-10">
                    <button class="btn btn-danger btn-block"
                            onclick="rpcAndShowData('${pageContext.request.contextPath}/commons/spider/deleteAll')">
                        删除全部已停止爬虫
                    </button>
                </div>
            </div>
